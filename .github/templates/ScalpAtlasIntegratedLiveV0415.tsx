    ...
    <View style={styles.safe}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.subtitle}>LIVE • {SCALP_ATLAS_COUNT} modele • v0.4.15</Text>
        </View>
      ...
      {screen === 'LIVE' && (
        <ScrollView contentContainerStyle={styles.page}>
          {!showGuide && (
            ...
            >
              <Text style={styles.guideQuickButtonText}>GHID RAPID</Text>
            </Pressable>
          )}
          {!permission ? (
            ...
            <>
                ...
                <View style={styles.guideCard}>
                  <View style={styles.guideHeader}>
                    <View>
                      ...
                      <Text style={styles.guideSub}>3 pași pentru o analiză LIVE corectă{guideAppearance > 0 ? ` • afișare ${guideAppearance}/3` : ''}</Text>
                    </View>
                    <Text style={styles.guideVersion}>v0.4.15</Text>
                  </View>
              ...
              <Text style={styles.clientFooter}>SCALP ATLAS • v0.4.15 • Semnalele sunt estimări, nu garanții. Decizia de tranzacționare aparține utilizatorului.</Text>
            </>
          )}
        </ScrollView>
      )}
