  ...
  const onAnalyzerMessage = (event: WebViewMessageEvent) => {
    try {
      ...
      if (payload.type === 'RESULT') {
        ...
        const result: AnalysisResult = timeframeRef.current
          ? rawResult
            ...
            <>
              ...
              <View style={styles.resultCard}>
                ...
                <Text style={styles.status}>
                  Cameră: {cameraReady ? 'PREGĂTITĂ' : 'INIȚIALIZARE'} • Motor: {engineReady ? 'PREGĂTIT' : 'INIȚIALIZARE'} • TF: {detectedTimeframe || 'AUTO'} • Scanare: ~2 sec
                </Text>
              </View>
