...
const GUIDE_KEY = 'scalpAtlas.live.guide.v0417.count';
    ...
    <View style={styles.safe}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.subtitle}>LIVE • {SCALP_ATLAS_COUNT} {t('models')} • v0.4.17 • {languageCode.toUpperCase()}{regionCode ? `-${regionCode}` : ''}</Text>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.page}>
          ...
          {!permission ? (
            ...
            <>
              {showGuide && (
                <View style={styles.guideCard}>
                  <View style={styles.guideHeader}>
                    ...
                    <Text style={styles.guideVersion}>v0.4.17</Text>
                  </View>
              ...
              <Text style={styles.clientFooter}>SCALP ATLAS • v0.4.17 • {t('disclaimer')}</Text>
            </>
          )}
        </ScrollView>
      )}
